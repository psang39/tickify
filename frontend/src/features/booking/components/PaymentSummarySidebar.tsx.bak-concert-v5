...
export function PaymentSummarySidebar({
  ...
  return (
    <div className="w-full lg:w-[380px] shrink-0 rounded-[2rem] overflow-hidden shadow-[0_20px_40px_rgba(0,0,0,0.06)] self-start lg:sticky lg:top-6 bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-white/10">
      <div className="p-8 pb-6">
        <h3 className="text-l font-bold text-slate-800 dark:text-slate-100 mb-8">Chi tiết thanh toán</h3>
        <div className="space-y-4 text-sm">
          ...
          <div className="flex justify-between items-start text-slate-500 dark:text-slate-400 pt-2">
            ...
            <span className="font-medium text-slate-800 dark:text-slate-100">{totalPrice.toLocaleString('vi-VN')} đ</span>
          </div>
          <div className="flex justify-between items-center text-slate-500 dark:text-slate-400">
            <span>Phí xử lý</span>
            <span className="font-medium text-slate-800 dark:text-slate-100">0 đ</span>
          </div>
        </div>
      </div>
