...
export function ThemeToggle({ variant = 'inline' }: ThemeToggleProps) {
  ...
  const className = variant === 'floating'
    ...
    : 'inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/10 dark:border-white/10 bg-white dark:bg-slate-900/90 text-slate-200 dark:text-slate-200 shadow-sm transition hover:bg-slate-950/70 dark:hover:bg-slate-800 dark:border-white/15 dark:bg-white/10 dark:text-white dark:hover:bg-white/15';
