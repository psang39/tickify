        ...
        switch (status) {
            ...
            case 'private':
                return {
                    ...
                    className: 'bg-slate-100 dark:bg-slate-800/80 text-slate-200 dark:text-slate-200 border-white/10 dark:border-white/10',
                };
            case 'draft':
            default:
                return {
                ...
                <CardContent className="p-0">
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm min-w-[980px]">
                            <thead className="text-xs uppercase text-slate-400 border-b border-slate-100 dark:border-white/10 bg-slate-950/70/80">
                                <tr>
                            ...
                            <tbody className="divide-y divide-slate-100 dark:divide-white/10">
                                {filteredEvents.length === 0 ? (
                                    ...
                                    return (
                                        <tr key={event._id} className="hover:bg-slate-950/70/70">
