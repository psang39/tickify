...
export default function ShowDetail() {
    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA] relative pb-24 font-sans w-full overflow-x-hidden">
            ...
            <div className="bg-white dark:bg-slate-900/90 border-b border-white/10 dark:border-white/10 px-6 lg:px-12 py-5 flex flex-col md:flex-row md:items-center justify-between gap-4 sticky top-0 z-40">
                <div className="flex items-center gap-4">
                    <button
                        onClick={() => navigate(`/organizer/events/${eventId}`, { state: { activeTab: 'SHOWS' } })}
                        className="p-2.5 rounded-full hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-500 dark:text-slate-400 transition-colors border border-white/10 dark:border-white/10"
                    >
                        <ArrowLeft size={20} />
                    </button>
                    <div>
                        <h1 className="text-2xl font-bold text-slate-100 dark:text-slate-100">{formData.name || 'Đang cập nhật...'}</h1>
                ...
                <div className="flex bg-slate-100 dark:bg-slate-800/80 p-1 rounded-xl self-start md:self-center border border-white/10 dark:border-white/10">
                    <button
                ...
                {/* TRẠNG THÁI CHỈ ĐỌC */}
                <div className="flex items-center gap-2 px-3 py-1.5 border border-white/10 dark:border-white/10 rounded-lg bg-slate-950/70 dark:bg-slate-900/80 text-xs font-bold self-start md:self-center">
                ...
                <div className="w-full max-w-6xl mx-auto px-6 lg:px-12 mt-8 grid grid-cols-1 xl:grid-cols-3 gap-8 animate-in fade-in duration-150">
                    ...
                    <div className="xl:col-span-2 space-y-8">
                        ...
                        <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-6 sm:p-8 border border-gray-100 dark:border-white/10">
                            <h2 className="text-lg font-bold text-slate-100 dark:text-slate-100 mb-6 flex items-center gap-2 border-b border-slate-50 dark:border-white/10 pb-3"><Info className="text-primary" size={18} /> Thông tin cơ bản</h2>
                            <div className="space-y-5">
                                <div>
                                    ...
                                    <input type="text" disabled={currentStatus === 'published' || currentStatus === 'cancelled'} className="w-full bg-slate-950/70 dark:bg-slate-900/80 border border-white/10 dark:border-white/10 rounded-lg p-3 outline-none focus:ring-2 focus:ring-primary/10 focus:border-primary font-medium text-slate-100 dark:text-slate-100 disabled:opacity-60" value={formData.name} placeholder="VD: Đêm diễn 1 - Hà Nội" onChange={(e) => setFormData({ ...formData, name: e.target.value })} />
                                </div>
                                <div>
                                    ...
                                    <textarea rows={3} disabled={currentStatus === 'published' || currentStatus === 'cancelled'} className="w-full bg-slate-950/70 dark:bg-slate-900/80 border border-white/10 dark:border-white/10 rounded-lg p-3 outline-none focus:ring-2 focus:ring-primary/10 focus:border-primary font-medium text-slate-600 dark:text-slate-300 resize-none disabled:opacity-60" value={formData.description} placeholder="Yêu cầu cổng soát vé hoặc ghi chú riêng..." onChange={(e) => setFormData({ ...formData, description: e.target.value })} />
                                </div>
                            </div>
                        </div>

                        <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-6 sm:p-8 border border-gray-100 dark:border-white/10">
                            <h2 className="text-lg font-bold text-slate-100 dark:text-slate-100 mb-6 flex items-center gap-2 border-b border-slate-50 dark:border-white/10 pb-3"><Clock className="text-primary" size={18} /> Mốc lịch trình mở khóa</h2>
                        ...
                        <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-6 sm:p-8 border border-gray-100 dark:border-white/10">
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6 border-b border-slate-50 dark:border-white/10 pb-3">
                                <h2 className="text-lg font-bold text-slate-100 dark:text-slate-100 flex items-center gap-2"><Ticket className="text-primary" size={18} /> Loại vé & giá bán</h2>
                            ...
                            {isTicketTypeLocked && (
                                <div className="mb-4 bg-slate-950/70 dark:bg-slate-900/80 border border-white/10 dark:border-white/10 text-slate-600 dark:text-slate-300 p-3 rounded-xl flex items-start gap-2 text-xs font-medium">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
                                <div className="lg:col-span-2 bg-slate-950/70 dark:bg-slate-900/80 border border-slate-100 dark:border-white/10 rounded-xl p-4 space-y-3">
                                    <div className="flex items-center justify-between">
                                        <h3 className="text-xs font-bold text-slate-200 dark:text-slate-200 uppercase tracking-wide">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-white dark:bg-slate-900/90 border border-white/10 dark:border-white/10 rounded-lg p-2 text-xs font-medium outline-none focus:border-primary disabled:opacity-60"
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                        <div>
                                            ...
                                            <input
                                                type="datetime-local"
                                                disabled={isTicketTypeLocked}
                                                className="w-full bg-white dark:bg-slate-900/90 border border-white/10 dark:border-white/10 rounded-lg p-2 text-[11px] font-medium outline-none focus:border-primary disabled:opacity-60"
                                ...
                                <div className="lg:col-span-3 space-y-3">
                                    {isLoadingTicketTypes ? (
                                        <div className="p-6 border border-dashed border-white/10 dark:border-white/10 rounded-xl text-center text-xs font-bold text-slate-400">Đang tải loại vé...</div>
                                    ) : ticketTypes.length === 0 ? (
                                        <div className="p-6 border border-dashed border-white/10 dark:border-white/10 rounded-xl text-center text-xs font-bold text-slate-400">Chưa có loại vé nào. Hãy upload SVG/tạo show để hệ thống sinh loại vé tương ứng.</div>
                                    ) : (
                                            ...
                                            <div key={ticketType._id} className="border border-slate-100 dark:border-white/10 rounded-xl p-4 flex flex-col md:flex-row md:items-center justify-between gap-3 hover:border-primary/20 transition-colors">
                                                <div className="space-y-1 min-w-0">
                                                    <div className="flex flex-wrap items-center gap-2">
                                                        <h4 className="font-bold text-sm text-slate-100 dark:text-slate-100 truncate">{ticketType.name}</h4>
                                                ...
                                                <div className="flex items-center gap-2 shrink-0">
                                                    <Button
                                                        ...
                                                        className="h-8 px-3 rounded-full text-xs font-bold border-white/10 dark:border-white/10"
                                                    >
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-6 border border-gray-100 dark:border-white/10">
                            <h3 className="font-bold text-sm mb-3 text-slate-100 dark:text-slate-100 flex items-center gap-2">
                                ...
                                <div className="space-y-4">
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full border border-white/10 dark:border-white/10 rounded-lg py-2 px-3 outline-none focus:border-primary text-xs font-medium bg-slate-950/70 dark:bg-slate-900/80 focus:bg-white disabled:opacity-60 transition-colors"
                                        ...
                                        {isVenueDropdownOpen && !['published', 'cancelled'].includes(currentStatus) && (
                                            <div className="absolute z-30 w-full mt-1 bg-white dark:bg-slate-900/90 border border-white/10 dark:border-white/10 rounded-lg max-h-48 overflow-y-auto bg-white dark:bg-slate-900/90">
                                                {filteredVenues.map((venue: any) => (
                                                    <div key={venue._id} className="px-3 py-2.5 hover:bg-slate-950/70 dark:hover:bg-slate-800 cursor-pointer border-b border-gray-50 text-xs" onMouseDown={() => { setFormData({ ...formData, venue_id: venue._id }); setVenueSearch(venue.name); setIsVenueDropdownOpen(false); }}>
                                                        <div className="font-semibold text-slate-100 dark:text-slate-100">{venue.name} ({venue.city || 'Chưa rõ thành phố'})</div>
                                    ...
                                    {formData.venue_id && (
                                        <div className="p-3 bg-slate-950/70 dark:bg-slate-900/80 border border-slate-100 dark:border-white/10 rounded-xl flex items-start gap-2 text-slate-600 dark:text-slate-300 animate-in fade-in">
                                    ...
                                    <div className="space-y-3">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full border border-white/10 dark:border-white/10 rounded-lg py-1.5 px-3 outline-none focus:border-primary text-xs font-medium bg-slate-950/70 dark:bg-slate-900/80 focus:bg-white transition-all text-slate-200 dark:text-slate-200"
                                            />
                                        </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-2.5">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full border border-white/10 dark:border-white/10 rounded-lg py-1.5 px-3 outline-none focus:border-primary text-xs font-medium bg-slate-950/70 dark:bg-slate-900/80 focus:bg-white font-mono text-slate-200 dark:text-slate-200"
                                                />
                                            </div>
                                            <div>
                        ...
                        <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-6 border border-gray-100 dark:border-white/10">
                            <h3 className="font-bold text-sm mb-3 text-slate-100 dark:text-slate-100">Sơ đồ ghế (SVG Map)</h3>
                            <div className="w-full bg-slate-950/70 dark:bg-slate-900/80 border-2 border-dashed border-white/10 dark:border-white/10 rounded-xl p-4 text-center">
                                {formData.stadium_map_svg ? (
                                    <div className="flex flex-col items-center py-2">
                                        <CheckCircle2 size={20} className="text-emerald-600 mb-1" />
                                        <span className="text-xs font-bold text-slate-200 dark:text-slate-200">Đã nhận diện file SVG</span>
                                    </div>
                                ) : (
                                ...
                                {!['published', 'cancelled'].includes(currentStatus) && (
                                    <label className="mt-2 inline-flex items-center justify-center px-3 py-1.5 bg-white dark:bg-slate-900/90 border border-gray-300 rounded-md text-[11px] font-bold text-slate-200 dark:text-slate-200 hover:bg-slate-950/70 dark:hover:bg-slate-800 cursor-pointer transition-colors">
                        ...
                        <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-6 border border-gray-100 dark:border-white/10 space-y-4">
                            <h3 className="font-bold text-sm text-slate-100 dark:text-slate-100 flex items-center gap-2"><img src="" alt="" /><Users size={16} className="text-primary" /> Nhân viên điều phối ca</h3>

                            {currentStatus !== 'cancelled' && (
                                <div className="p-3 bg-slate-950/70 dark:bg-slate-900/80 rounded-xl border border-slate-100 dark:border-white/10 space-y-2">
                                    ...
                                    <div className="flex gap-1.5">
                                        <select
                                            ...
                                            className="flex-1 bg-white dark:bg-slate-900/90 border border-white/10 dark:border-white/10 rounded-lg p-2 text-xs font-medium outline-none focus:border-primary"
                                        >
                                ...
                                <div className="space-y-2 max-h-48 overflow-y-auto">
                                    {assignedStaff.length === 0 ? (
                                        ...
                                        assignedStaff.map((s: any) => (
                                            <div key={s._id} className="flex items-center justify-between p-2.5 bg-slate-950/70 dark:bg-slate-900/80 rounded-lg border border-gray-100 dark:border-white/10 text-xs">
                                                <div className="min-w-0 flex-1 pr-2">
                                                    <div className="font-bold text-slate-100 dark:text-slate-100 truncate">{s.first_name} {s.last_name}</div>
            ...
            {activeTab === 'LIVE' && (
                <div className="w-full max-w-4xl mx-auto px-6 lg:px-12 mt-8 space-y-6 animate-in fade-in duration-150">
                    ...
                    <div className="flex justify-between items-center bg-white dark:bg-slate-900/90 border border-white/10 dark:border-white/10 px-5 py-4 rounded-xl">
                        <div className="space-y-0.5">
                            <h3 className="font-bold text-sm text-slate-100 dark:text-slate-100 flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-1.5 bg-slate-950/70 dark:bg-slate-900/80 border border-white/10 dark:border-white/10 px-3 py-1.5 rounded-full text-xs font-bold">
