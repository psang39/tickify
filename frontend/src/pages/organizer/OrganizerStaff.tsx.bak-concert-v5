                    ...
                    <CardContent className="p-0">
                        <div className="overflow-x-auto">
                            <table className="w-full min-w-[880px] text-sm">
                                <thead className="bg-slate-50 dark:bg-slate-900/80 text-xs uppercase tracking-wider text-slate-400 border-b border-slate-100 dark:border-white/10">
                                    <tr>
                ...
                <Card className="border-slate-200 dark:border-white/10 rounded-2xl shadow-none h-fit">
                    ...
                    <CardContent className="p-5 space-y-4">
                        ...
                        <div>
                            ...
                            <select value={selectedShowId} onChange={(e) => setSelectedShowId(e.target.value)} disabled={!selectedEventId} className="mt-1 w-full border border-slate-200 dark:border-white/10 rounded-xl px-3 py-2 text-sm bg-white dark:bg-slate-900/90 focus:outline-primary disabled:bg-slate-50">
