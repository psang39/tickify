    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA] relative pb-24 font-sans w-full overflow-x-hidden">
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-4 w-full">
                            <div className={`bg-white/20 backdrop-blur-md text-white px-1 py-0.5 rounded-full font-semibold border border-white/30 flex items-center w-fit focus-within:bg-white/40 transition-all ${isInfoTab && currentStatus === 'draft' ? '' : 'pointer-events-none opacity-90'}`}>
                                ...
                                <input
                                    ...
                                    value={eventFormData.genre} placeholder="Dòng nhạc..." onChange={(e) => setEventFormData({ ...eventFormData, genre: e.target.value })}
                                />
                            </div>
            ...
            <div className="w-full max-w-6xl mx-auto px-6 lg:px-12 mt-8">
                <div className="flex gap-4 border-b border-white/10 dark:border-white/10">
            ...
            <div className="w-full max-w-6xl mx-auto px-6 lg:px-12 mt-8">
                        ...
                        <div className="xl:col-span-2 space-y-10">
                            ...
                            <div>
                                ...
                                <div className="bg-white dark:bg-slate-900/90 border border-white/10 dark:border-white/10 rounded-2xl p-6 flex flex-col md:flex-row gap-6 items-center bg-gradient-to-r from-slate-50 to-white">
                                    ...
                                    <div className="flex-1 w-full space-y-1.5"><label className="text-xs font-bold text-slate-200 dark:text-slate-200 uppercase tracking-wide">Ngày bế mạc</label><input type="datetime-local" disabled={currentStatus !== 'draft'} className="w-full bg-white dark:bg-slate-900/90 border border-gray-300 rounded-lg p-3 outline-none focus:ring-2 focus:ring-primary/20 font-medium text-sm disabled:opacity-60" value={eventFormData.end_date} onChange={(e) => setEventFormData({ ...eventFormData, end_date: e.target.value })} /></div>
                                </div>
                            </div>
                        </div>
                ...
                {activeTab === 'SHOWS' && (
                    <div className="space-y-6 animate-in fade-in">
                        <div className="flex justify-between items-center bg-white dark:bg-slate-900/90 p-6 rounded-2xl border border-white/10 dark:border-white/10">
                            <div>
                                <h2 className="text-xl font-bold text-slate-100 dark:text-slate-100">Danh sách Shows</h2>
                        ...
                        {showForm && currentStatus !== 'draft' && (
                            <form onSubmit={handleCreateAllShow} className="bg-white dark:bg-slate-900/90 p-8 rounded-2xl border border-white/10 dark:border-white/10 space-y-6 animate-in slide-in-from-top-4">
                                    ...
                                    <div className="relative">
                                        ...
                                        {!isCreatingNewVenue ? (
                                            ...
                                            <div className="relative">
                                                ...
                                                {isVenueDropdownOpen && (
                                                    <div className="absolute z-20 w-full mt-1 bg-white dark:bg-slate-900/90 border border-white/10 dark:border-white/10 rounded-lg max-h-48 overflow-y-auto">
                                                        {filteredVenues.map((venue: any) => (
                                                            <div key={venue._id} className="px-4 py-2.5 hover:bg-slate-950/70 dark:hover:bg-slate-800 cursor-pointer border-b border-gray-50"
                                                                ...
                                                                <div className="font-semibold text-slate-100 dark:text-slate-100 text-xs">{venue.name}</div>
                                            ...
                                            <div className="bg-slate-950/70 dark:bg-slate-900/80 border border-white/10 dark:border-white/10 rounded-xl p-4 space-y-3 animate-in fade-in duration-200">
                                                <div className="flex justify-between items-center border-b border-white/10 dark:border-white/10 pb-1.5">
                                                ...
                                                <div className="space-y-2">
                                                    <div>
                                                        ...
                                                        <input type="text" placeholder="VD: Khách sạn Mường Thanh" value={newVenueForm.name} onChange={e => setNewVenueForm({ ...newVenueForm, name: e.target.value })} className="w-full border border-gray-300 bg-white dark:bg-slate-900/90 rounded-lg py-1.5 px-3 outline-none text-xs text-slate-200 dark:text-slate-200" />
                                                    </div>
                                                    <div className="grid grid-cols-3 gap-2">
                                                        <div className="col-span-2">
                                                            <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wide mb-1 block">Địa chỉ chi tiết *</label>
                                                            <input type="text" placeholder="VD: 78 Khúc Thừa Dụ" value={newVenueForm.address} onChange={e => setNewVenueForm({ ...newVenueForm, address: e.target.value })} className="w-full border border-gray-300 bg-white dark:bg-slate-900/90 rounded-lg py-1.5 px-3 outline-none text-xs text-slate-200 dark:text-slate-200" />
                                                        </div>
                                                        ...
                                                        <div className="col-span-1">
                                                            ...
                                                            <input type="text" placeholder="Hà Nội" value={newVenueForm.city} onChange={e => setNewVenueForm({ ...newVenueForm, city: e.target.value })} className="w-full border border-gray-300 bg-white dark:bg-slate-900/90 rounded-lg py-1.5 px-3 outline-none text-xs text-slate-200 dark:text-slate-200" />
                                                        </div>
                                                    </div>
                                ...
                                <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start pt-4 border-t border-slate-100 dark:border-white/10">
                                    <div className="xl:col-span-4 border-2 border-dashed border-white/10 dark:border-white/10 bg-slate-950/70/50 hover:bg-slate-950/70 dark:hover:bg-slate-800 p-8 rounded-2xl text-center h-full flex flex-col justify-center">
                                        <UploadCloud size={40} className="mx-auto text-primary mb-3" />
                                        <h3 className="text-base font-bold text-slate-50 dark:text-slate-50 mb-1">Sơ đồ ghế (Seat Map)</h3>
                                        ...
                                        <label className="inline-flex items-center justify-center bg-white dark:bg-slate-900/90 border border-white/10 dark:border-white/10 text-slate-200 dark:text-slate-200 px-6 py-2.5 rounded-full font-semibold cursor-pointer hover:bg-slate-950/70 dark:hover:bg-slate-800 transition-all text-xs">
                                    ...
                                    <div className="xl:col-span-8 bg-slate-950/70 dark:bg-slate-900/80 border border-white/10 dark:border-white/10 rounded-2xl p-6 h-full">
                                        <div className="flex justify-between items-center mb-4">
                                            <h3 className="font-bold text-slate-100 dark:text-slate-100 text-sm flex items-center gap-2">
                                        ...
                                        {ticketTypes.length === 0 ? (
                                            ...
                                            <div className="space-y-4 max-h-[450px] overflow-y-auto pr-2">
                                                {ticketTypes.map((ticket, index) => (
                                                    <div key={index} className="bg-white dark:bg-slate-900/90 p-4 rounded-xl border border-white/10 dark:border-white/10 relative group">
                                                        <div className="flex items-center gap-2 mb-3 bg-slate-100 dark:bg-slate-800/80 px-3 py-2 rounded-lg w-fit border border-white/10 dark:border-white/10">
                                                        ...
                                                        <div className="grid grid-cols-12 gap-4 mb-3">
                                                            <div className="col-span-12">
                                                                ...
                                                                <input required type="text" placeholder="VD: Vé VIP Khu Vực A" className="w-full text-xs border border-white/10 dark:border-white/10 rounded p-2 outline-none focus:border-primary bg-slate-950/70 dark:bg-slate-900/80 font-bold text-slate-100 dark:text-slate-100"
                                                        ...
                                                        <div className="grid grid-cols-12 gap-4 mb-3">
                                                            <div className="col-span-5">
                                                                ...
                                                                <input required type="number" min="0" placeholder="0" className="w-full text-xs border border-white/10 dark:border-white/10 rounded p-2 outline-none focus:border-primary font-bold text-orange-600 bg-slate-950/70 dark:bg-slate-900/80"
                                                            ...
                                                            <div className="col-span-4">
                                                                ...
                                                                <input type="number" min="1" placeholder={isStandingTier(ticket.target_tier) ? 'VD: 500' : 'Theo số ghế'} className="w-full text-xs border border-white/10 dark:border-white/10 rounded p-2 outline-none focus:border-primary bg-slate-950/70 dark:bg-slate-900/80"
                                                        ...
                                                        <div className="grid grid-cols-2 gap-4 mb-3">
                                                            <div>
                                                                ...
                                                                <input required type="datetime-local" className="w-full text-xs border border-white/10 dark:border-white/10 rounded p-2 outline-none focus:border-primary bg-slate-950/70 dark:bg-slate-900/80"
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="text" placeholder="Nhập các quyền lợi đi kèm..." className="w-full text-xs border border-white/10 dark:border-white/10 rounded p-2 outline-none focus:border-primary bg-slate-950/70 dark:bg-slate-900/80"
                                ...
                                {shows.length === 0 ? (
                                    ...
                                    shows.map((show: any) => (
                                        <div
                                            ...
                                            className="bg-white dark:bg-slate-900/90 border border-white/10 dark:border-white/10 rounded-2xl p-6 hover:border-primary/50 cursor-pointer transition-all group shadow-none"
                                        >
                                            <div className="flex justify-between items-start mb-4">
                                                <h3 className="font-bold text-base text-slate-100 dark:text-slate-100 group-hover:text-primary transition-colors line-clamp-2">{show.name}</h3>
