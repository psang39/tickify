...
export default function AdminDashboard() {
    ...
    return (
        <div className="w-full max-w-6xl animate-in fade-in duration-300 space-y-12 pb-16">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="flex flex-col">
                                ...
                                <input
                                    ...
                                    className="border border-slate-200 dark:border-white/10 rounded-xl p-3 bg-slate-50 dark:bg-slate-950/70 dark:bg-slate-900/80 text-sm font-medium focus:outline-none focus:border-primary focus:bg-white transition-all text-slate-700 dark:text-slate-200"
                                />
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                            <div className="flex flex-col md:col-span-1">
                                ...
                                <input
                                    ...
                                    className="border border-slate-200 dark:border-white/10 rounded-xl p-3 bg-slate-50 dark:bg-slate-950/70 dark:bg-slate-900/80 text-sm font-medium focus:outline-none focus:border-primary focus:bg-white transition-all font-mono text-slate-700 dark:text-slate-200"
                                />
                            </div>
            ...
            <section className="bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-white/10 rounded-[24px] overflow-hidden concert-poster-card">
                <div className="px-6 py-5 border-b border-slate-200 dark:border-white/10 flex justify-between items-center bg-slate-950/70/50">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-slate-200 dark:border-white/10 text-xs uppercase tracking-wider text-slate-400 font-bold bg-slate-950/70/30">
