...
export default function ManageUsersPage() {
    ...
    return (
        <div className="w-full max-w-6xl animate-in fade-in duration-300">
            ...
            <div className="bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-white/10 rounded-[24px] overflow-hidden shadow-none">
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-slate-200 dark:border-white/10 text-xs uppercase tracking-wider text-slate-400 font-bold bg-slate-50/50">
                        ...
                        <tbody>
                            {users.length === 0 && !isLoading ? (
                                ...
                                users.map((user: any) => (
                                    <tr key={user._id} className="border-b border-slate-100 dark:border-white/10 hover:bg-slate-50/50 transition-colors">
                ...
                <div className="px-6 py-4 border-t border-slate-200 dark:border-white/10 bg-slate-50/30 flex items-center justify-between">
