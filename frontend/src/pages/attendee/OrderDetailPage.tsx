...
function getPaymentStatusMeta(status?: string) {
    ...
    if (!normalizedStatus) {
        return {
            ...
            cardClassName: 'bg-slate-100 dark:bg-slate-800/80 border border-white/10 dark:border-white/10',
            textClassName: 'text-slate-200 dark:text-slate-200',
            amountClassName: 'text-slate-200 dark:text-slate-200',
            badgeClassName: 'bg-slate-100 dark:bg-slate-800/80 text-slate-600 dark:text-slate-300 border-white/10 dark:border-white/10'
        };
    }
