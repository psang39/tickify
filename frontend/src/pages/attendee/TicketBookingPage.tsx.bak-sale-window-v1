...
export default function TicketBookingPage() {
                  ...
                  <div className="border-b border-slate-100 dark:border-white/10 p-5">
                    ...
                    <div className="grid grid-cols-3 rounded-2xl bg-slate-100 dark:bg-slate-800/80 p-1 text-sm font-semibold text-slate-500 dark:text-slate-400">
                      <button
                        ...
                        className={`rounded-xl px-2 py-2 transition-colors ${activeFilterTab === "combo" ? "bg-white text-primary shadow-sm dark:bg-slate-950 dark:text-pink-300" : "hover:text-slate-100 dark:hover:text-slate-100"}`}
                      >
                        Số vé
                      </button>
                      <button
                        ...
                        className={`rounded-xl px-2 py-2 transition-colors ${activeFilterTab === "price" ? "bg-white text-primary shadow-sm dark:bg-slate-950 dark:text-pink-300" : "hover:text-slate-100 dark:hover:text-slate-100"}`}
                      >
                        Giá
                      </button>
                      <button
                        ...
                        className={`rounded-xl px-2 py-2 transition-colors ${activeFilterTab === "ticketType" ? "bg-white text-primary shadow-sm dark:bg-slate-950 dark:text-pink-300" : "hover:text-slate-100 dark:hover:text-slate-100"}`}
                      >
                        Hạng vé
                      </button>
                    </div>
                          ...
                          {ticketTypesData.map((type: any) => {
                            ...
                            return (
                              <button
                                ...
                                className={`w-full rounded-2xl border px-4 py-3 text-left transition-colors ${isSelected ? "border-primary bg-primary/10 text-slate-50 dark:text-slate-50 dark:border-pink-400/70 dark:bg-pink-500/15 dark:text-pink-100" : "border-white/10 bg-white dark:bg-slate-900/90 text-slate-500 dark:text-slate-400 hover:border-slate-300 dark:border-white/10 dark:bg-slate-900/80 dark:text-slate-300 dark:hover:border-pink-400/50"}`}
                              >
                ...
                <div className="border border-slate-200 dark:border-white/10 rounded-2xl overflow-hidden shadow-sm bg-white dark:bg-slate-900/90">
                  ...
                  <div className="p-6 flex flex-wrap gap-4">
                    <div
                      ...
                      className={`w-32 h-24 rounded-xl border-2 flex flex-col items-center justify-center gap-2 cursor-pointer transition-all ${paymentMethod === "VNPAY" ? "border-blue-500 bg-blue-50/50 shadow-[0_0_0_4px_rgba(59,130,246,0.1)] dark:border-blue-300/70 dark:bg-blue-500/15" : "border-white/10 hover:border-slate-300 dark:border-white/10 dark:hover:border-blue-300/50"}`}
                    >
  ...
  return (
    <div
      className={`min-h-screen ${currentStep === 4 ? "bg-slate-950/70" : "bg-background"} relative`}
    >
      <LoadingOverlay
        isVisible={
      ...
      <main className="max-w-[1440px] mx-auto px-8 py-6">
        ...
        <div
          className={`${currentStep === 4 ? "bg-slate-950/70" : "bg-background"} rounded-2xl p-2`}
        >
          {renderStepContent()}
        </div>
