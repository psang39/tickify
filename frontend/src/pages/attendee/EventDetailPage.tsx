                ...
                <aside className="space-y-5">
                    <div className="rounded-3xl border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/90 p-5">
                        ...
                        <div className="mt-4 aspect-[3/4] overflow-hidden rounded-2xl bg-slate-100 dark:bg-slate-800/80">
                            {event.poster_url ? <img src={event.poster_url} alt={event.name} className="h-full w-full object-cover" /> : <div className="flex h-full items-center justify-center text-slate-600 dark:text-slate-300"><ImageIcon size={36} /></div>}
                        </div>
                    </div>
                    <div className="rounded-3xl border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/90 p-5">
