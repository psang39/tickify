          ...
          <div ref={seatMapSectionRef} className="w-full scroll-mt-6">
            <div className="mb-3 flex justify-end">
              <div className="flex items-center gap-5 rounded-2xl bg-slate-100 dark:bg-slate-800/80 px-4 py-3 text-sm font-semibold text-slate-700 dark:text-slate-200 shadow-sm">
                ...
                <div className="flex items-center gap-2">
                  <span className="h-3 w-3 rounded-full bg-white dark:bg-slate-900/90 border border-slate-300 inline-block" />
                  <span>Còn trống</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div className="overflow-hidden rounded-3xl border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/90 shadow-sm">
              <div className="flex flex-col xl:flex-row">
                ...
                <aside className="w-full xl:w-[380px] border-t xl:border-t-0 xl:border-l border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/90 flex flex-col">
                  <div className="border-b border-slate-100 dark:border-white/10 p-5">
                    ...
                    <div className="grid grid-cols-3 rounded-2xl bg-slate-100 dark:bg-slate-800/80 p-1 text-sm font-semibold text-slate-500 dark:text-slate-400">
                      <button
                        type="button"
                        onClick={() => setActiveFilterTab("combo")}
                        className={`rounded-xl px-2 py-2 transition-colors ${activeFilterTab === "combo" ? "bg-white text-primary shadow-sm dark:bg-slate-950 dark:text-pink-300" : "hover:text-slate-800 dark:hover:text-slate-100"}`}
                      >
                        Số vé
                      </button>
                      <button
                        ...
                        className={`rounded-xl px-2 py-2 transition-colors ${activeFilterTab === "price" ? "bg-white text-primary shadow-sm dark:bg-slate-950 dark:text-pink-300" : "hover:text-slate-800 dark:hover:text-slate-100"}`}
                      >
                        Giá
                      </button>
                      <button
                        ...
                        className={`rounded-xl px-2 py-2 transition-colors ${activeFilterTab === "ticketType" ? "bg-white text-primary shadow-sm dark:bg-slate-950 dark:text-pink-300" : "hover:text-slate-800 dark:hover:text-slate-100"}`}
                      >
                        Hạng vé
                      </button>
                    </div>
                  ...
                  <div className="flex-1 overflow-y-auto p-5">
                    ...
                    {activeFilterTab === "price" && (
                      <div className="space-y-5">
                        ...
                        <div className="rounded-2xl bg-slate-50 dark:bg-slate-900/80 px-4 py-3 text-center text-base font-bold text-slate-800 dark:text-slate-100">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <input
                            ...
                            className="h-11 w-full rounded-xl border border-slate-200 px-3 text-center text-base outline-none focus:border-primary dark:border-white/10 dark:bg-slate-950/70 dark:text-slate-100 dark:focus:border-pink-400"
                            placeholder="Từ"
                          />
                          <input
                            type="number"
                          ...
                          {ticketTypesData.map((type: any) => {
                            ...
                            return (
                              <button
                                ...
                                className={`w-full rounded-2xl border px-4 py-3 text-left transition-colors ${isSelected ? "border-primary bg-primary/10 text-slate-900 dark:text-slate-50 dark:border-pink-400/70 dark:bg-pink-500/15 dark:text-pink-100" : "border-slate-200 bg-white dark:bg-slate-900/90 text-slate-500 dark:text-slate-400 hover:border-slate-300 dark:border-white/10 dark:bg-slate-900/80 dark:text-slate-300 dark:hover:border-pink-400/50"}`}
                              >
                            ...
                            return (
                              <div key={zoneId} className={`rounded-2xl border p-4 transition-colors ${isActive ? "border-primary bg-primary/5" : "border-slate-200 bg-white"}`}>
                                ...
                                <div className="flex items-center justify-between gap-3">
                                  ...
                                  <div className="min-w-[96px] rounded-xl bg-slate-50 dark:bg-slate-900/80 px-4 py-2 text-center text-sm font-bold text-slate-800 dark:text-slate-100">{selectedCount} vé</div>
              ...
              <div className="border-t border-slate-100 dark:border-white/10 bg-white dark:bg-slate-900/90 px-5 py-5">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                  <div className="min-w-0 flex-1">
                    {selectedSeats.length === 0 ? (
                      <div className="rounded-2xl border border-dashed border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-slate-900/80 px-5 py-4 text-sm text-slate-500 dark:text-slate-400">
                          ...
                          return (
                            ...
                            >
                              ...
                              <button
                                ...
                                className="shrink-0 rounded-full p-2 text-slate-400 transition-colors hover:bg-red-50 hover:text-red-500 dark:hover:bg-red-500/15 dark:hover:text-red-300"
                              >
                                <Trash2 size={16} />
                              </button>
                            </div>
                  ...
                  <div className="flex shrink-0 flex-col gap-3 sm:flex-row sm:items-center">
                    <div className="rounded-2xl bg-slate-50 dark:bg-slate-900/80 px-5 py-3 text-right">
      ...
      case 3:
        return (
          <div className="w-full min-h-[500px] bg-white dark:bg-slate-900/90 rounded-xl p-8 border border-gray-100 dark:border-white/10 flex flex-col items-center">
            ...
            <div className="w-full max-w-2xl bg-slate-50 dark:bg-slate-900/80 rounded-xl p-6 border border-slate-200 dark:border-white/10">
            ...
            <div className="bg-white dark:bg-slate-900/90 flex-1 w-full flex flex-col gap-10 px-6 rounded-2xl border border-slate-200 dark:border-white/10 py-8">
              <div>
                ...
                <div className="ml-2 pl-6 border-l-4 border-pink-300 flex flex-col gap-5">
                  ...
                  <div className="flex items-center gap-4 text-slate-700 dark:text-slate-200">
                    ...
                    <input
                      type="text"
                      className="w-full bg-transparent outline-none font-medium placeholder-slate-300 text-slate-500 dark:text-slate-400"
              ...
              <div>
                ...
                <div className="border border-slate-200 dark:border-white/10 rounded-2xl overflow-hidden shadow-sm bg-white dark:bg-slate-900/90">
                  <div className="bg-slate-50 dark:bg-slate-900/80 px-5 py-4 border-b border-slate-200 dark:border-white/10 flex items-center gap-3 text-slate-600 dark:text-slate-300 font-medium">
                  ...
                  <div className="p-6 flex flex-wrap gap-4">
                    <div
                      ...
                      className={`w-32 h-24 rounded-xl border-2 flex flex-col items-center justify-center gap-2 cursor-pointer transition-all ${paymentMethod === "VNPAY" ? "border-blue-500 bg-blue-50/50 shadow-[0_0_0_4px_rgba(59,130,246,0.1)] dark:border-blue-300/70 dark:bg-blue-500/15" : "border-slate-200 hover:border-slate-300 dark:border-white/10 dark:hover:border-blue-300/50"}`}
                    >
                    ...
                    <div
                      ...
                      className={`w-32 h-24 rounded-xl border-2 flex flex-col items-center justify-center gap-2 cursor-pointer transition-all ${paymentMethod === "MOCK" ? "border-blue-500 bg-blue-50/50 shadow-[0_0_0_4px_rgba(59,130,246,0.1)] dark:border-blue-300/70 dark:bg-blue-500/15" : "border-slate-200 hover:border-slate-300 dark:border-white/10 dark:hover:border-blue-300/50"}`}
                    >
    ...
    >
      ...
      <main className="max-w-[1440px] mx-auto px-8 py-6">
        ...
        {currentStep !== 2 && currentStep !== 5 && currentStep !== 4 && (
          <div className="mt-8 flex justify-between items-center border-t border-gray-200 dark:border-white/10 pt-6 pb-10">
