...
import { createEvent, getEvents, getEventById, getPublicEventFilters, searchEventsPublic } from '../controllers/event.controller';
...
eventRouter.get('/filters', getPublicEventFilters);
